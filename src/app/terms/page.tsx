  ...
  return (
    <div className="terms">
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Bizim
        Consulting AB.
        <br />
        Bizim Consulting AB is committed to ensuring that the app is as useful
        ...
        <br />
        The Dinqili app stores and processes personal data that you have
        ...
        features and it could mean that the Dinqili app won’t work properly or
        at all.
        <br />
        ...
        <br />
        You should be aware that there are certain things that Bizim Consulting
        AB will not take responsibility for. Certain functions of the app will
        require the app to have an active internet connection. The connection
        can be Wi-Fi or provided by your mobile network provider, but Bizim
        Consulting AB cannot take responsibility for the app not working at full
        ...
        turn it on to avail the Service, Bizim Consulting AB cannot accept
        responsibility.
        <br />
        With respect to Bizim Consulting AB’s responsibility for your use of the
        ...
        we can make it available to you. Bizim Consulting AB accepts no
        ...
        updates if you want to keep using the app. Bizim Consulting AB does not
        ...
        do not hesitate to contact us at alp@ilbiz.studio.
      </p>
    </div>
  );
};
