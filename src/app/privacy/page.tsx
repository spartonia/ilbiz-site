...
const page = () => {
  return (
    <div className="privacy">
      ...
      <p>
        Bizim Consulting AB built the Dinqili app as a Free app. This SERVICE is
        provided by Bizim Consulting AB at no cost and is intended for use as
        is.
      </p>
      <p>
        ...
        meanings as in our Terms and Conditions, which are accessible at Dinqili
        ...
        websites that you visit and are stored on your device&apos;ßs internal
        memory.
        <br />
        ...
        not hesitate to contact us at alp@ilbiz.studio.
      </p>
    </div>
  );
};
